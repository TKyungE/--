...
namespace Client
{
	...
	enum COLLISIONGROUP { COLLISION_PLAYER, COLLISION_MONSTER, COLLISION_BOSS, COLLISION_OBJECT, COLLISION_ITEM, COLLISION_PLAYERSKILL, COLLISION_MONSTERSKILL, COLLISION_PORTAL, COLLISION_PET, COLLISION_END };
}
#include <time.h>
#include <string>
#include <io.h>
