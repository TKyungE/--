...
HRESULT CMeteorEff::SetUp_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Components(TEXT("Com_Texture"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_MeteorEff"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
