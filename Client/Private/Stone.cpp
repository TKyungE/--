...
HRESULT CStone::SetUp_Components(void)
{
	...
	if (FAILED(__super::Add_Components(TEXT("Com_Texture"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_Stone"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
void CStone::OnTerrain(void)
{
	...
	vPosition.y = pVIBuffer_Terrain->Compute_Height(vPosition, pTransform_Terrain->Get_WorldMatrix(), 0.f);
