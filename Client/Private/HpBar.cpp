...
HRESULT CHpBar::SetUp_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Components(TEXT("Com_Texture"), m_tInfo.pTarget->Get_Info().iLevelIndex, TEXT("Prototype_Component_Texture_HpBar"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
